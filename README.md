...
|---|---|---|
| `/doc` — Feishu doc creation | ✅ | 11 block types: para, h1/h2/h3, bullet, ordered, todo, fenced code (17 languages), quote, divider, callout + inline styles (bold/italic/code/link) |
